...
export function loadConfig(): AppConfig {
  return {
    ...
    adminUsername: process.env.ADMIN_USERNAME || process.env.ADMIN_USER || 'admin',
    adminPasswordHash: process.env.ADMIN_PASSWORD || process.env.ADMIN_PASSWORD_HASH || process.env.ADMIN_PASS || 'admin123',
